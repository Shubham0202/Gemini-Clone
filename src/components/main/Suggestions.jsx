...
const Suggestions = ({text,icon}) => {
    ...
    return (
        <div onClick={handleSuggestions} className='shrink-0 w-52 max-w-52 flex flex-col justify-between rounded-lg shadow shadow-gray-300 bg-slate-50 hover:bg-blue-50 transition duration-500 p-3 cursor-default sm:cursor-pointer'>
